...
public class ItemModelGenerator extends ItemModelProvider {
    ...
    private void sofa(String color) {
        ...
        Identifier parent = modLoc("block/deco/sofa/%s/single".formatted(color));
    ...
    private void barStool(String color) {
        ...
        getBuilder(name)
                ...
                .texture("particle", Identifier.withDefaultNamespace("block/%s_wool".formatted(color)))
    ...
    private void stringLights(String color) {
        ...
        Identifier parent = modLoc("block/deco/string_lights/%s".formatted(color));
        withExistingParent(name, parent);
    }

    private void painting(Supplier<? extends Item> item, String name) {
        Identifier key = Objects.requireNonNull(BuiltInRegistries.ITEM.getKey(item.get()));
